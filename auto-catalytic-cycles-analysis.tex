...
\begin{scope} [shift={(-6.6cm,-4cm)}]
  ...
  \fill[genext!0.5!geninit] (\fromang+\deltaang+1:\autocatalscale*\autocatalrad-\autocatalscale*\arcwidth) arc (\fromang+\deltaang+1:\fromang+\deltaang-1:\autocatalscale*\autocatalrad-\autocatalscale*\arcwidth)
    ...
    \node [rectangle,fill=autocatacyc!40,rounded corners=3pt] at (90:\autocatalscale*\autocatalrad+1cm) (eq) {Internal metabolite + External metabolite $\rightarrow (1+\alpha)$ Internal metabolite};
  \end{scope}
\end{tikzpicture}
\caption{
...
\begin{scope} [shift={(9cm,-13.5cm)},radius=2cm]
  ...
  \node[anchor=north] at(-0.15cm,-3.1cm) (glyreac) {mal + {\fontfamily{cmss}\selectfont 2} aca $\rightarrow$ {\fontfamily{cmss}\selectfont 2} mal};
