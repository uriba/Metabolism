...
Different definitions exist for autocatalytic systems in the context of chemical reactions \cite{Hordijik, Kauffman, Kun2008-xg, \dots}.
...
(A) Cyclicity with regard to the set of metabolites - each metabolite of the cycle serves both as a substrate of at least one reaction of the cycle and as a product of at least one reaction of the cycle.
(B) Cyclicity with regard to the set of reactions - at least one substrate of each reaction in the cycle, and one product of each reaction in the cycle are metabolites of the cycle.
...
We implemented an algorithm to search for autocatalytic cycles in central carbon metabolism (see methods).
...
\begin{tikzpicture}
  ...
  %%%% upper pts
  \node[shape=coordinate,left=of g6p.center] (ptsmid) {};
  \node[metaboliteStyle,assimcol,left=6mm of ptsmid] (gluc) {gluc};
  \node[metaboliteStyle,below left=of g6p.center] (pyr1) {pyr};
  \draw[assimcol] (gluc) -- (ptsmid);
  \draw[->] (ptsmid) [out=0,in=0] to (pyr1);
    ...
    \begin{figure}[h!]
      \begin{minipage}[c]{.3\linewidth}%
        {\begin{tikzpicture}[>=latex',node distance = 2cm]
            ...
            \draw [->,line width=1pt,branchout] (X.south) arc (190:270:1cm) node [pos=0.3,right] {$f_b$};
    ...
    \begin{figure}[h!]
      ...
      \begin{minipage}[c]{0.8\linewidth}%
        {\begin{tikzpicture}[>=latex',node distance = 2cm]
            ...
            \draw [->,line width=1pt,autocatacyc] (X.south) arc (345:15:1cm) node [pos=0.5,left] (fa) {$f_a$};
            \draw [->,line width=1pt,branchout] (X.south) arc (190:270:1cm) node [pos=0.3,right] {$f_b$};
            \draw [<-,line width=1pt,magenta] (X.east) arc (-70:0:0.5cm and 1cm) node [pos=0.3,right] (fi) {$f_i$};
            \node [above of=fa,yshift=-1cm] (A) {(A)};
...
\begin{tikzpicture}
  ...
  \begin{scope}[shift={(1.5cm,0cm)}]
    ...
    \node[metaboliteStyle,below=of g6p.center] (f6p) {f6p};
    %%% ptstop
    \node[shape=coordinate,left= of g6p] (ptsmid) {};
    \node[metaboliteStyle,left= of f6p] (pyr1) {pyr};
    ...
    \draw[figArrowStyle,line width=\glucpts/2,autocataby] ([yshift=-3/4*\glucpts]ptsmid) [out=0,in=90] to ([shift={(0.5cm,-0.8cm)}]ptsmid) [out=-90,in=0] to (pyr1);
  ...
  \begin{scope}[shift={(8cm,0cm)}]
    ...
    \node[shape=coordinate,below=of fbp.center](fbamid) {};
    %%% ptstop
    \node[shape=coordinate,left= of fbp] (ptsmid) {};
    \node[metaboliteStyle,shift={(-1.7cm,-0.3cm)}] at (fbamid) (pyr1) {pyr};
    ...
    \draw[figArrowStyle,line width=\frucpts/2,autocataby] ([yshift=-3/4*\frucpts]ptsmid) [out=0,in=90] to ([shift={(0.5cm,-0.8cm)}]ptsmid) [out=-90,in=0] to (pyr1);
