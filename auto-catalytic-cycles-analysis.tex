    ...
    \begin{figure}[h!]
      \begin{minipage}[c]{.3\linewidth}%
        {\begin{tikzpicture}[>=latex',node distance = 2cm]
            \tikzset{
                v1style/.style={opacity=0.3,pattern=north west lines}}
            \tikzset{
                v2style/.style={opacity=0.3,pattern=dots}}
            \tikzset{
                k1style/.style={opacity=0.2,fill=cyan}}
            \tikzset{
                k2style/.style={opacity=0.2,fill=magenta}}
            \node (X) {$X$};
            ...
            \end{customlegend}
            \begin{axis}[name=phase,xmin=0,ymin=0,xmax=2,ymax=2,xlabel={$\frac{V_{\max,b}}{V_{\max,a}}$},ylabel={$\frac{K_{M,b}}{K_{M,a}}$},samples=6,at=(legend1.south west),anchor=above north west,width=4.5cm,height=4.5cm,yshift=-1.2cm,ytick={0,1,2},xtick={0,1,2}]
          ...
          %  \draw[k1style] (axis cs:0,0) -- (axis cs:2,2) -- (axis cs:0,2) --cycle;
          %  \draw[k2style] (axis cs:0,0) -- (axis cs:2,2) -- (axis cs:2,0) --cycle;
          %  \draw[v1style] (axis cs:0,0) -- (axis cs:0,2) -- (axis cs:1,2) -- (axis cs:1,0) --cycle;
          %  \draw[v2style] (axis cs:1,0) -- (axis cs:1,2) -- (axis cs:2,2) -- (axis cs:2,0) --cycle;
          \end{axis}
          \node [at=(legend1.south west),yshift=-0.8cm] (B) {(B)};

          %\node [at=(B.south),anchor=north] (k1) {\scriptsize{$\frac{K_{M,b}}{K_{M,a}}>\frac{V_{\max,b}}{V_{\max,a}}$}};
          %\draw [k1style,rectangle] ([yshift=-1mm]k1.east) rectangle ++ (3mm,2mm) ;
          %\node [at=(k1.south west),anchor=north west] (k2) {\scriptsize{$\frac{K_{M,b}}{K_{M,a}}<\frac{V_{\max,b}}{V_{\max,a}}$}};
          %\draw [k2style,rectangle] ([yshift=-1mm]k2.east) rectangle ++ (3mm,2mm) ;

          %\node [at=(k1.east),anchor=west,xshift=4mm] (v1) {\scriptsize{$V_{\max,b}<V_{\max,a}$}};
          %\draw [v1style,rectangle] ([yshift=-1mm]v1.east) rectangle ++ (3mm,2mm) ;
          %\node [at=(v1.south west),anchor=north west] (v2) {\scriptsize{$V_{\max,b}>V_{\max,a}$}};
          %\draw [v2style,rectangle] ([yshift=-1mm]v2.east) rectangle ++ (3mm,2mm) ;
       ...
       \begin{minipage}[c]{.65\linewidth}
        {\begin{tikzpicture}
            \begin{axis}[name=plot1,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=2.9,ymax=5.9,xlabel={$X$},ylabel={flux},samples=60,width=5cm,height=6cm,clip=false,yticklabels={,,},xticklabels={,,},tick label style={major tick length=0pt}]
          ...
          \begin{axis}[name=plot3,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=2.9,ymax=5.9,xlabel={$X$},ylabel={flux},samples=60,at=(plot1.below south west),anchor=above north west,width=5cm,height=6cm,yshift=-0.5cm,yticklabels={,,},xticklabels={,,},tick label style={major tick length=0pt}]
          ...
          \begin{axis}[name=plot4,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=2.9,ymax=5.9,xlabel={$X$},ylabel={flux},samples=60,at=(plot3.right of south east),anchor=left of south west,width=5cm,height=6cm,yticklabels={,,},xticklabels={,,},tick label style={major tick length=0pt}]
    ...
    \begin{figure}[h!]
      ...
      \begin{minipage}[c]{0.9\linewidth}%
        {\begin{tikzpicture}[>=latex',node distance = 2cm]
            ...
            \node [above of=fa,yshift=-1cm] (A) {(A)};
            \begin{customlegend}[legend entries={$f_a+f_i$,$f_b$,$\dot{X}=f_a+f_i-f_b$},legend style={right=3cm of X,anchor=west,name=legend1}]
              \addlegendimage{autocatacyc,fill=black!50!red,sharp plot}
              \addlegendimage{branchout,fill=black!50!red,sharp plot}
              \addlegendimage{sumcolor,fill=black!50!red,sharp plot}
            \end{customlegend}
...
\begin{tikzpicture}
  ...
  \newcommand{\coloredRatio}[2]{%top,bottom
      {\Large {$\sfrac{\mathbf{\color{branchout}#1\%}}{\mathbf{\color{autocatacyc}#2\%}}$}}
  }
  ...
  \begin{scope}[shift={(-6cm,-7.5cm)}]
    ...
    \draw[capArrowStyle=branchout,line width=\galcappck,branchout!40] (oaa) -- (pep);
    ...
    \draw[capArrowStyle=branchout,line width=\galcapicd*1.5,branchout!40] (icit) -- (akg);
  ...
  \begin{scope}[shift={(-6cm,0cm)}]
    ...
    \node[ratioRect,anchor=south east] at (oaa.north west) (aceb1) {\coloredRatio{\acecapvalpck}{\acecapvalglt}};
    ...
    \draw[capArrowStyle=branchout,line width=\acecappck,branchout!40] (oaa) -- (pep);
    \draw[figArrowStyle,line width=\acepck,branchout] (oaa) -- (pep);
    \draw[capArrowStyle=branchout,line width=\acecapmae,branchout!40] (mal) -- (pyr);
    \node[ratioRect,anchor=south east] at (mal.north west) (aceb2) {\coloredRatio{\acecapvalmae}{\acecapvalmdh}};
    ...
    \draw[capArrowStyle,line width=\acecapacea,autocatacyc!40] ([xshift=\acecapacea*0.35]midacea) -- ([xshift=\acecapacea*0.4]suc);
    \node[ratioRect,anchor=south] at (icit.north) (aceb3) {\coloredRatio{\acecapvalicd}{\acecapvalacea}};
    ...
    \draw[capArrowStyle=branchout,line width=\acecapicd*1.5,branchout!40] (icit) -- (akg);
    ...
    \draw[figArrowStyle,line width=\acemdh,autocatacyc] (mal) -- (oaa);
  ...
  \begin{scope}[shift={(1.5cm,0cm)}]
    ...
    \node[metaboliteStyle,below=of pep.center] (pyr) {pyr};
    \node[metaboliteStyle,right=of g6p] (6pgi) {6pgi};
    \draw[figArrowStyle,line width=\glucpgi,autocatacyc] (g6p) -- (f6p);
    ...
    \draw[capArrowStyle=branchout,line width=\gluccappyk,branchout!40] (pep) -- (pyr);
    \draw[figArrowStyle,line width=\glucpyk,branchout] (pep) -- (pyr);
    \draw[capArrowStyle=branchout,line width=\gluccapppc,branchout!40] (pep) -- (oaa);
    ...
    \draw[capArrowStyle=branchout,line width=\gluccapzwf,branchout!40] (g6p) -- (6pgi);
    ...
    \node[shape=coordinate,left=2.5cm of pep.center] (pts3) {};
    \draw[line width=\glucpts/2,autocatacyc] (pep.west) -- (pts3);
  ...
  \begin{scope}[shift={(8cm,0cm)}]
    ...
    \node[metaboliteStyle,right=of pep] (oaa) {oaa};
    \node[metaboliteStyle,below=of pep.center] (pyr) {pyr};
    \draw[figArrowStyle,line width=\frucfbp,branchout] (fbp)-- (f6p) ;
    ...
    \draw[capArrowStyle=branchout,line width=\fruccappyk,branchout!40] (pep) -- (pyr);
    \draw[figArrowStyle,line width=\frucpyk,branchout] (pep) -- (pyr);
    \draw[capArrowStyle=branchout,line width=\fruccapppc,branchout!40] (pep) -- (oaa);
    ...
    \node[shape=coordinate,left=2.5cm of pep.center] (pts3) {};
    \draw[line width=\frucpts/2,autocatacyc] ([yshift=\frucpts/4]pep.west) -- (pts3);
    \node[shape=coordinate,left=2.5cm of pyr.center] (pts5) {};
...
\caption{
  Major branch points and relative enzyme saturation in operating autocatalytic cycles. In all cases there is enough excess capacity in the branching reactions to prevent the cycle from overflowing.
  Moreover, only in one out of the 8 branch points observed (the branch point at fbp in growth under fructose), the outgoing reaction is significantly more saturated than the autocatalytic reaction.
