...
We identified 4 classes of autocatalytic cycles in central carbon metabolism (where for some classes a few different variations are possible).
...
\begin{figure}[h!]
\centering
\includegraphics[scale=1]{central-carbon-met-take2.pdf}
    \caption {
    Examples of 4 autocatalytic cycles in central carbon metabolism.
    ...
    The reaction colored in red is the dominant reaction branching out of the cycle.
