\section{Introduction}
    ...
    Regarding intermediate metabolites, the metabolic system evidently produces them, but it is not a priori evident that specific intermediate metabolites must exist in order for the metabolic system to catabolize external nutrients.
...
implying that for all $i$:
  ...
  \end{equation}
    ...
    On the other hand, to decrease $X^*$, and as a result the autocatalytic and branch fluxes, the autocatalytic reactions should be inhibited and the branch reactions should be activated.
