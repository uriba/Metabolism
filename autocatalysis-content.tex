\section{Introduction}
    ...
    It then follows that any essential component of a living system is autocatalytic, if it is required for reproduction, because  such a component is being used in the reproduction process that leads to the duplication of itself.
