...
\begin{itemize}
    ...
    \item A cycle formed by the glucose phosphotransferase system (PTS) in bacteria.
...
Arrow width in panels represent relative carbon flux.
}
\end{figure}
...
\end{figure}
    ...
    We further analyze the ability of specific allosteric interactions to support fast convergence and stability of autocatalytic cycles in the methods section.
...
\mtcsettitle{secttoc}{The methods section is composed of the following sections:}
\mtcsetpagenumbers{secttoc}{off}
\mtcsetrules{secttoc}{off}
\mtcsetoffset{secttoc}{-4.0em}
\mtcsetformat{secttoc}{tocrightmargin}{-4.0em}
%\mtcsetfeature{secttoc}{open}{\vspace{-1.5cm}}
