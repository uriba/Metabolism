\section{Introduction}
    ...
    This basic ability makes all living systems autocatalytic by definition.
    ...
    Specifically, the metabolic system of any living organism, composed of the intermediate metabolites and enzymes catalyzing its reactions, is autocatalytic as a whole and must enable both the excess production of each of its metabolites, as well as the production of all the precursor molecules needed in order for the translation-transcription machinary to synthesize new copies of its enzymes.
    An autocatalytic system is inherently unstable as its operation changes the amount of its components.

    In this work we focus on autocatalytic cycles in chemical reaction systems, and specifically in metabolic networks.
    The components we consider are the metabolites of the system, and autocatalytic cycles are formed using the reactions of the metabolic network.
    We show that general traits of autocatalytic cycles have specific implications in this context, implications that can be translated to concrete design principles and boundries on kinetic parameters of participating enzymes.

    While the whole metabolic system is autocatalytic, and clearly, enzymes must be present in order for the metabolic system to function and generate the precursors needed for synthesis of new enzymes, metabolites may not obligatorily be present in the system in order for it to produce excess amounts of them, given input nutrients.
    However, and despite the essentiality of functioning metabolic networks, such networks often do require the availability of certain metabolites, in addition to the nutrients consumed, in order to function, with the most common example being co-factors \cite{Kun2008-xg}.
    ...
    Metabolic autocatalytic cycles present specific control challenges as their inherent feed-back nature makes them susceptible to instabilities such as divergence or drainage of their intermediate metabolites \cite{Fell1999,Reznik2010-te}.
    The smaller and simpler an autocatalytic cycle is, the more concrete are the implications its function imposes on specific parameters connected to its operation.
    ...
    In this work we present the specific requirements metabolic autocatalytic cycles must meet in order to operate:
...
\begin{enumerate}
    ...
    \item Various parts of the pentose-phosphate pathway (PP) assimilating imported sugars that are incorporated into central carbon metabolism as the intermediate metabolites: ribose-5p, erythrose-4P, sedoheptulose-7P or xylulose-5p to later produce these carbon compounds at higher stoichiometries (Figure \ref{fig:extrasamps}, example I).
    \item Cycles assimilating glycerone-phosphate and using the Entner-Doudoroff (ED) pathway \cite{Entner1952-xs}.
        They first use the fructose bisphosphate aldolase reaction in the reverse direction, producing fructose-1,6-bisphosphate from glyceraldehyde-3-phosphate, then convert the fructose back into two glyceraldehyde-3-phosphate (Figure \ref{fig:extrasamps}, example II).
\end{enumerate}
