...
\begin{tikzpicture}
 \colorlet{ptsinit}{cyan}
  ...
  \node[metaboliteStyle,left=6mm of ptsmid] (gluc) {gluc};
  ...
  \node[metaboliteStyle,below=of pyr.center] (aca) {accoa};
  ...
  \node[metaboliteStyle] at(2pg -| xu5p.center) (co2) {\ce{CO2}};
  \draw[->] (g6p) -- (f6p);
...
\begin{scope} [shift={(9cm,-13.5cm)},radius=2cm]
  \draw[lightgray,rounded corners=\highlightrad] (-2.4cm,-3cm) rectangle +(4.5,5.5);
  \node at (-2cm,2.2cm) (II) {\large  \textbf {II}};
  \node[anchor=north] at(-0.15cm,-3.1cm) (glyreac) {mal + {\fontfamily{cmss}\selectfont 2} accoa $\rightarrow$ {\fontfamily{cmss}\selectfont 2} mal};
  ...
  \colorlet{glyinter}{blue}
    ...
    \draw[color=glyext,line width=\glywidth] (90:\glyemmmrad) arc(-90:-130:2cm) node [pos=0.5,color=black,anchor=south,xshift=1.5mm] (acac) {accoa};
...
\subsection{Steady state existance and stability analysis of a simple autocatalytic cycle}
...
We denote the flux through the reaction branching out of the cycle by $f_b$.
    ...
    \begin{figure}[h!]
      \begin{tikzpicture}[>=latex',node distance = 2cm]
        ...
        \tikzset{
            vstyle/.style={opacity=0.3,pattern=north west lines,cyan}}
        \tikzset{
            kstyle/.style={opacity=0.3,pattern=north east lines,magenta}}
      \begin{scope}[shift={(-4cm,4cm)}]
            \node at (0:1cm) (X) {$X$};
            \node[shape=coordinate] (orig) {};
            \draw [->,line width=1pt,autocatacyc] (X.south) arc (345:15:1cm) node [pos=0.4,above right] (fa) {$f_a$} node [pos=0.5,shape=coordinate] (midauto) {};
            \draw [line width=1pt,assimcol] (midauto) arc (0:-40:1cm);
            \draw [->,line width=1pt,branchout] ([xshift=1mm]X.south) arc (190:270:1cm) node [pos=0.3,right] {$f_b$};
            \node at (-2.1cm,1cm) (A) {(A)};
            \begin{customlegend}[legend entries={$f_a$,$V_{\max,b}>V_{\max,a}$,$f_b$,$\sfrac{V_{\max,b}}{V_{\max,a}}<\sfrac{K_{M,b}}{K_{M,a}}$,$\dot{X}=f_a-f_b$},legend style={right=2.5cm of orig,anchor=west,name=legend1},legend columns=2]
              \addlegendimage{autocatacyc,fill=black!50!red,sharp plot,line width=1pt}
              \addlegendimage{vstyle,area legend}
              \addlegendimage{branchout,fill=black!50!red,sharp plot,line width=1pt}
              \addlegendimage{kstyle,area legend}
              \addlegendimage{sumcolor,fill=black!50!red,sharp plot,dashed,line width=1pt}
            \end{customlegend}
      \end{scope}
      \begin{scope}[shift={(-1.5cm,-\gridsize/2)}]
            \begin{axis}[name=phase,clip=false,xmin=0,ymin=0,xmax=2,ymax=2,ylabel={$\frac{V_{\max,b}}{V_{\max,a}}$},xlabel={$\frac{K_{M,b}}{K_{M,a}}$},samples=6,width=\gridsize,height=\gridsize,ytick={0,1,2},xtick={0,1,2}]
            ...
            \draw[->,black!50,dashed] (axis cs:0.25,1.33) -- +(-1.5cm,0cm);
            \draw[->,black!50,dashed] (axis cs:1.75,1.33) -- +(1.2cm,0cm);
            \draw[->,black!50,dashed] (axis cs:0.25,0.66) -- +(-1.5cm,0cm);
            \draw[->,black!50,dashed] (axis cs:1.75,0.66) -- +(1.2cm,0cm);
            \node[align=left,anchor=east] at (axis cs:1.75,1.33) (I) {I};
            \node[align=right,anchor=west] at (axis cs:0.25,1.33) (II) {II};
            \node[align=right,anchor=west] at (axis cs:0.25,0.66) (III) {III};
            \node[align=left,anchor=east] at (axis cs:1.75,0.66) (IV) {IV};
          \end{axis}

          \begin{axis}[name=plot1,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=2.9,ymax=5.9,xlabel={$X$},ylabel={flux},samples=60,width=\plotwidth,height=\plotheight,clip=false,yticklabels={,,},xticklabels={,,},tick label style={major tick length=0pt},at=(phase.right of north east),anchor=left of north west,axis background/.style={fill=cyan!50!magenta,opacity=0.3}]
            \addplot[domain=0:2.9,autocatacyc,thick] {3*x/(0.1+x)};
            \addplot[domain=0:2.9,branchout,thick] {5*x/(1+x)};
            \addplot[domain=0:2.9,sumcolor,thick,dashed] {3*x/(0.1+x)-5*x/(1+x)};
          ...
          \begin{axis}[name=plot2,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=2.9,ymax=5.9,xlabel={$X$},ylabel={flux},samples=60,at=(phase.left of north west),anchor=right of north east,width=\plotwidth,height=\plotheight,yticklabels={,,},xticklabels={,,},tick label style={major tick length=0pt},axis background/.style=vstyle]
            \addplot[domain=0:4,autocatacyc,thick] {4*x/(1+x)};
            \addplot[domain=0:4,branchout,thick] {5*x/(0.2+x)};
            \addplot[domain=0:4,sumcolor,thick,dashed] {4*x/(1+x)-5*x/(0.2+x)};
            \node[right,align=left] (twotext) at (axis cs:0.0,5) {\scriptsize stable zero steady state};
          \end{axis}

          \begin{axis}[name=plot3,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=2.9,ymax=5.9,xlabel={$X$},ylabel={flux},samples=60,width=\plotwidth,height=\plotheight,yticklabels={,,},xticklabels={,,},tick label style={major tick length=0pt},at=(phase.left of south west),anchor=right of south east]
            \addplot[domain=0:4,autocatacyc,thick] {5*x/(1+x)};
            \addplot[domain=0:4,branchout,thick] {3*x/(0.1+x)};
            \addplot[domain=0:4,sumcolor,thick,dashed] {5*x/(1+x)-3*x/(0.1+x)};
            \addplot[dashed,gray,thick] coordinates {(1.25,0) (1.25,2.77)};
            \node[right,align=left] (threetext) at (axis cs:0.05,4.7) {\scriptsize unstable non-zero\\[-0.4em]\scriptsize steady state};
          \end{axis}

          \begin{axis}[name=plot4,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=2.9,ymax=5.9,xlabel={$X$},ylabel={flux},samples=60,at=(phase.right of south east),anchor=left of south west,width=\plotwidth,height=\plotheight,yticklabels={,,},xticklabels={,,},tick label style={major tick length=0pt},axis background/.style=kstyle]
            \addplot[domain=0:2.9,autocatacyc,thick] {5*x/(0.2+x)};
            \addplot[domain=0:2.9,branchout,thick] {4*x/(1+x)};
            \addplot[domain=0:2.9,sumcolor,thick,dashed] {5*x/(0.2+x)-4*x/(1+x)};
            \node[right,align=left] (fourtext) at (axis cs:0.05,5) {\scriptsize  no stable steady state};
         \end{axis}
          \node [at=(plot2.north west),xshift=-0.5cm,yshift=0.3cm] (B) {(B)};
        \end{scope}
      \end{tikzpicture}
