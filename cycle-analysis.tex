    ...
    \begin{figure}[h]
      ...
      \begin{minipage}[c]{.3\linewidth}%
        {\begin{tikzpicture}[>=latex',node distance = 2cm]
            ...
            \begin{customlegend}[legend entries={$f_a$,$f_b$,$\dot{X}=f_a-f_b$},legend style={below=2.5cm of fa,anchor=west,name=legend1}]
            ...
            \end{customlegend}
            \begin{axis}[name=phase,xmin=0,ymin=0,xmax=2,ymax=2,xlabel={$\frac{V_{\max,b}}{V_{\max,a}}$},ylabel={$\frac{K_{m,b}}{K_{m,a}}$},samples=6,at=(legend1.south west),anchor=above north west,width=4.5cm,height=4.5cm,yshift=-1cm]
            ...
            \node (four) at (axis cs:1.5,0.5) {VI};
          \end{axis}
         \end{tikzpicture}}%
       \end{minipage}
       \hfill
        %{\subcaption{Auto-catalytic cycle\label{fig:autocatal}}}
        %\pushfigure[c]{.65\linewidth}
       \begin{minipage}[c]{.65\linewidth}
        {\begin{tikzpicture}[scale=0.7]
            \begin{axis}[name=plot1,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=3,ymax=6,xlabel={$X$},ylabel={flux},samples=60,width=7cm,height=8cm]
          ...
          \begin{axis}[name=plot2,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=3,ymax=6,xlabel={$X$},ylabel={flux},samples=60,at=(plot1.right of south east),anchor=left of south west,width=7cm,height=8cm]
          ...
          \begin{axis}[name=plot3,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=3,ymax=6,xlabel={$X$},ylabel={flux},samples=60,at=(plot1.below south west),anchor=above north west,width=7cm,height=8cm]
          ...
          \begin{axis}[name=plot4,axis x line=middle,axis y line=left,xlabel near ticks,ylabel near ticks,xmin=0,ymin=-2.5,xmax=3,ymax=6,xlabel={$X$},ylabel={flux},samples=60,at=(plot3.right of south east),anchor=left of south west,width=7cm,height=8cm]
            ...
            \node (four) at (axis cs:0.5,5.5) {VI};
         \end{axis}
        \end{tikzpicture}}
       \end{minipage}
        ...
        When the reaction with higher flux has a steeper slope at $X=0$, no positive concentration steady state point exists ((\subref{fig:michmennointerceptstable}) and (\subref{fig:michmennointerceptunstable})).
        ...
        The steady state is stable if at the steady state point $\frac{d\dot{X}}{dX}<0$ (at $X=0$ in (\subref{fig:michmennointerceptstable}) and (\subref{fig:michmeninterceptunstable}) and at $X>0$ at (\subref{fig:michmeninterceptstable})).}
    \end{figure}
