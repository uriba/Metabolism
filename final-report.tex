...
\abstract{
    ...
    To survive and prosper, such systems employ extensive regulation mechanisms, fine tuning their operation to ensure proper function.
    My research focuses on the system wide effects, implications, and passive outcomes of such regulatory mechanisms.
    Specifically, I use simple models to extract testable, system wide implications emerging from the requirements of the models, then use multi-omix data to test the models predictions.
    The work spans two different domains of molecular biology: gene expression and metabolism.
    ...
    These analysis help unveil the underlying principles and logic behind observed phenomena in these two domains, as well as predict the behavior of synthetically engineered biological systems, assisting in their design towards proper function.
}
\newpage
\tableofcontents
\newpage
