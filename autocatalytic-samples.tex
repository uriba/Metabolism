\begin{tikzpicture}
 \colorlet{ptsinit}{cyan}
  ...
  \node[metaboliteStyle,left=7mm of ptsmid] (gluc) {gluc};
  ...
  \iftoggle{eddpathway}{
      ...
      \node[shape=coordinate,] at (pyr.center -| ru5p.center) (eddbottombr) {};
      ...
      \node[metaboliteStyle,left=7mm of ptsmid,rectangle,draw=assimcol,rounded corners=2pt] (glucassim) {gluc};
      \draw[assimcol,line width=\assimwidth] (gluc) -- (ptsmid);
      \node[metaboliteStyle,below=of pyr.center,rectangle,draw=assimcol,rounded corners=2pt] (acaassim) {accoa};
