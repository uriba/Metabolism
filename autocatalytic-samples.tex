\begin{tikzpicture}
 \colorlet{ptsinit}{cyan}
  ...
  \begin{scope} [shift={(11.2cm,-4.5cm)},radius=2cm,visible on=<2->]
    ...
    \preassim{\arcwidth}{-20}{-270}{\autocatalrad}{cbbinit}
    \postassim{\arcwidth}{90}{25}{\autocatalrad}{cbbinit}{6/5}
    \assim{\arcwidth}{90}{-30}{\autocatalrad}{6/5}
    \arrowhead{\arcwidth}{25}{\autocatalrad}{cbbinit}

    \begin{scope}[shift={(25+65/2:2*\autocatalrad+3/5*\arcwidth)}]
        \draw[color=cbbinit,line width=1/5*\arcwidth] (25+65/2+180:\autocatalrad) arc (25+65/2+180:25+65+180:\autocatalrad);
        \revarrowhead{\arcwidth/5}{25+65+180}{\autocatalrad}{cbbinit}
        \node[color=gray] at (290:\autocatalrad+\arcwidth/4) (rubptwo) {rubp};
    \end{scope}
    \node at(125:\autocatalrad+2.3*\arcwidth) (cotwo) {5 \ce{CO2}};

    \node at (0:\autocatalrad) (3pgc) {5 rubp};
...
\begin{scope} [shift={(8.9cm,-13.5cm)},radius=2cm,visible on=<4->]
  ...
  \colorlet{glyinter}{blue}
    ...
    \preassim{\arcwidth}{-20}{-270}{\autocatalrad}{glyinit}
    \postassim{\arcwidth}{90}{25}{\autocatalrad}{glyinit}{2}
    \assim{\arcwidth}{90}{-30}{\autocatalrad}{2}
    \arrowhead{\arcwidth}{25}{\autocatalrad}{glyinit}

    \begin{scope}[shift={(25+65/2:2*\autocatalrad+\arcwidth)}]
        \draw[color=glyinit,line width=\arcwidth] (25+65/2+180:\autocatalrad) arc (25+65/2+180:25+65+180:\autocatalrad);
        \revarrowhead{\arcwidth}{25+65+180}{\autocatalrad}{glyinit}
        \node[color=gray] at (290:\autocatalrad+\arcwidth/2) (glytwo) {mal};
    \end{scope}
...
\begin{scope} [shift={(-6.5cm,-5.5cm)},radius=2cm,visible on=<3->]
  ...
  \node[anchor=north] at(-0cm,-2.1cm) (ptsreac) {pep + gluc $\rightarrow$ {\fontfamily{cmss}\selectfont 2} pep + pyr};
    ...
    \arrowhead{\arcwidth}{25}{\autocatalrad}{ptsinit}
    \pgfmathsetlength{\ptsemrad}{\autocatalrad+\arcwidth};
    \pgfmathsetlength{\ptsesrad}{\autocatalrad+\arcwidth/2};
    \draw[color=autocatacyc,line width=3*\arcwidth] (100:\autocatalrad) arc(100:90:\autocatalrad);
    \draw[color=ptsinit,line width=\arcwidth] (60:\autocatalrad) arc(60:25:\autocatalrad);

    \pgfmathsetlength{\ptsarcwidth}{\autocatalrad-\arcwidth};
    \shadedarc[\arcwidth]{-20}{-260}{\autocatalrad}{\ptsarcwidth}{autocatacyc}{ptsinit}
    \colorgradarc{2*\arcwidth}{90}{60}{\ptsesrad}{autocatacyc}{ptsinit}
    \shadedarc[\arcwidth]{90}{50}{\ptsarcwidth}{\ptsarcwidth-\arcwidth}{white}{autocatacyc}
    \begin{scope}[shift={(60:2*\autocatalrad+\arcwidth)}]
        \draw[color=ptsinit,line width=\arcwidth] (240:\autocatalrad) arc (240:275:\autocatalrad);
        \revarrowhead{\arcwidth}{275}{\autocatalrad}{ptsinit}
        \node[color=gray] at (295:\autocatalrad+3*\arcwidth/4) (peptwo) {pep};
    \end{scope}


    \node at (0:\autocatalrad) (pepc) {pep};
    \node at (50:\ptsierad-0.2cm) (pyrc) {pyr};
