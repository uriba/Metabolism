\begin{tikzpicture}[>=latex',node distance = 2cm]
    ...
    \node at (-45:1cm) (X) {$X$};
    \draw [->,line width=1pt,autocatacyc] (X.south west) arc (300:-25:1cm) node [pos=0.63,above] (fa) {$f_a:$\small{$E+X\rightarrow2X$}} node [pos=0.5,shape=coordinate] (midauto) {};
    ...
    \draw [<-,line width=1pt,magenta] (X.east) arc (-90:-30:1cm) node [pos=0.3,above] (fi) {$f_i$};
    \iftoggle{article} {
        \node [] at(150:3cm) (A) {(A)};
    }{}
